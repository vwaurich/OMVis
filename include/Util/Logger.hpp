...
#ifdef USE_LOGGER
#define LOGGER_WRITE(message,category,level) OMVIS::Util::Logger::write(message,category,level)
#define LOGGER_WRITE_TUPLE(message,categoryLevel) OMVIS::Util::Logger::write(message,categoryLevel)
#else
