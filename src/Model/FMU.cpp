...
namespace OMVIS
{
    namespace Model
    {
        ...
        void FMU::initialize(const std::shared_ptr<SimSettings> simSettings)
        {
            // Initialize data
        ...
        {
            LOGGER_WRITE(std::string("Handle event at ") + std::to_string(_fmuData._tcur), Util::LC_CTR, Util::LL_DEBUG);
